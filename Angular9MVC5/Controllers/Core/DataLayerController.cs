...
namespace Angular9MVC5.Controllers.Core
{
    public class DataLayerController
    {
        private const string connectionString = "data source=DESKTOP-4KN8OBM\\SQLEXPRESS; initial catalog=MyDB;Integrated Security=True";
